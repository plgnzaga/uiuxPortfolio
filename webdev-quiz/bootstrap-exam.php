...
$display_query = "SELECT question,exam_code,choice_a,choice_b,choice_c,choice_d,correct_answer FROM bootstrap ";
    ...
    <div class="score-container">
        ...
        <?php
         if(isset($_POST['get_score'])){
             $user = $_GET['username'];
                  $display_correct = "SELECT correct_answer FROM bootstrap ";
