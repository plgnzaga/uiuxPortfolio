...
$display_query = "SELECT question,exam_code,choice_a,choice_b,choice_c,choice_d,correct_answer FROM php ";
...
<br>
    ...
    <div class="score-container">
        ...
        <?php
         if(isset($_POST['get_score'])){
             $user = $_GET['username'];
                  $display_correct = "SELECT correct_answer FROM php ";
         ...
         ${"q$i"} =  $_POST['Q'.$i];
             ...
             $insertquery = mysqli_query($connect,$insertScore);
                ...
                echo "<p>Hi ".$username." your score is <b>".$totalscore."</b>, Please try harder next time.</p>";
               }
    ...
    ?>
        <button class="view_dashboard">View Dashboard</button>
        </section>
    </div>
