...
<?php
    if(isset($_POST['submit'])){
        ...
        $query = "INSERT INTO javascript(exam_code,exam_title,question,choice_a,choice_b,choice_c,choice_d,correct_answer)
        ...
        <form method="POST">
           ...
           <center>
             <table class="table" style="width:500px;border:2px solid gray;margin-top:20px;flex:1;">
                 <th colspan="2" style="text-align:center"><h4>Javascript Test</h4></th>
                   <tr>
               ...
               <table class="table" style="width:500px;border:2px solid gray;margin-top:20px;flex:1;">
               <?php
                   $quests = "SELECT exam_code,question,correct_answer FROM javascript";
