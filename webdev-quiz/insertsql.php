...
<?php
    if(isset($_POST['submit'])){
        ...
        $exam_title = $_POST['exam_title'];
          $question = mysqli_real_escape_string($connect,htmlentities($_POST['question']));
        $choice_a = mysqli_real_escape_string($connect,htmlentities($_POST['choice_a']));
      
         $choice_b = mysqli_real_escape_string($connect,htmlentities($_POST['choice_b']));
        $choice_c = mysqli_real_escape_string($connect,htmlentities($_POST['choice_c']));
        $choice_d = mysqli_real_escape_string($connect,htmlentities($_POST['choice_d']));
        $correct_answer = $_POST['correct_answer'];
        
        
        
        $query = "INSERT INTO _sql(exam_code,exam_title,question,choice_a,choice_b,choice_c,choice_d,correct_answer)
        ...
        <form method="POST">
           ...
           <center>
             <table class="table" style="width:500px;border:2px solid gray;margin-top:20px;flex:1;">
                 <th colspan="2" style="text-align:center"><h4>SQL Test</h4></th>
                   <tr>
               ...
               <table class="table" style="width:500px;border:2px solid gray;margin-top:20px;flex:1;">
               <?php
                   $quests = "SELECT exam_code,question,correct_answer FROM _sql";
